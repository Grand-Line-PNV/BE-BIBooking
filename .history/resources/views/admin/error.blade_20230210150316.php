...
<head>
    ...
    .error-container>span.four:before {
        ...
        bottom: -43px;
        background:
            linear-gradient(128deg, #F16736 0%, #F16736 40%, transparent 41%, transparent 100%),
            linear-gradient(116deg, #F16736 0%, #F16736 50%, transparent 51%, transparent 100%),
            linear-gradient(to top, #99749D, #B895AB, #CC9AA6, #D7969E, #F16736);
    }

...
<head>
    ...
    .error-container>span.four:before {
        ...
        bottom: -43px;
        background:
            linear-gradient(128deg, #F16736 0%, rgba(0, 0, 0, 0.07) 40%, transparent 41%, transparent 100%),
            linear-gradient(116deg, #F16736 0%, rgba(0, 0, 0, 0.07) 50%, transparent 51%, transparent 100%),
